...
from AloneMusic.utils.database import (is_active_chat,
...
from AloneMusic.utils.inline.play import (panel_markup_1,
                                          panel_markup_2,
                                          panel_markup_3,
                                          stream_markup,
                                          telegram_markup)
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Alone.mute_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        await Alone.unmute_stream(chat_id)
        await CallbackQuery.message.reply_text(
