...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/TeamAloneOp/AloneMusicBot
   ```
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/TeamAloneOp/AloneMusicBot/pulls)
...
6. [Open a Pull Request](https://github.com/TeamAloneOp/AloneMusicBot/compare?expand=1)
