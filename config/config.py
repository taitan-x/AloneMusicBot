...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "𝐑αηι ✘ 𝐌υsι¢")
...
GITHUB_REPO = getenv("GITHUB_REPO", "t.me/taitangamer")
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/619725ecc62fe21c94923.jpg")
